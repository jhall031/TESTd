...
cd /usr/bin
wget -O add-ss "http://54.179.120.207/djtv/add-ss.sh"
wget -O del-ss "http://54.179.120.207/djtv/del-ss.sh"
wget -O cek-ss "http://54.179.120.207/djtv/cek-ss.sh"
wget -O renew-ss "http://54.179.120.207/djtv/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss

...
# Tambahan
cd /usr/bin
wget -O add-wg "http://54.179.120.207/djtv/add-wg.sh"
wget -O del-wg "http://54.179.120.207/djtv/del-wg.sh"
wget -O cek-wg "http://54.179.120.207/djtv/cek-wg.sh"
wget -O renew-wg "http://54.179.120.207/djtv/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
